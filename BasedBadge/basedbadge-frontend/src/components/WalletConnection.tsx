  ...
  if (isConnected) {
    return (
      <div className="relative">
        ...
        {showDropdown && (
          <div ref={dropdownRef} className="absolute right-0 mt-2 w-48 bg-white/5 backdrop-blur-xl rounded-lg shadow-xl z-50 border border-white/10">
            <div className="p-2">
        ...
        <div ref={dropdownRef} className="absolute right-0 mt-2 w-48 bg-white/5 backdrop-blur-xl rounded-lg shadow-xl z-50 border border-white/10">
          <div className="p-2">
            ...
            {availableConnectors.map((connector, index) => (
              ...
              >
                {isPending || isConnecting ? "Connecting..." : connector.name || "Wallet"}
              </button>
            ))}
          </div>
        </div>
